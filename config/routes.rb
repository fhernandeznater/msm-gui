Rails.application.routes.draw do
  ...
  post("/insert_actor_record", { :controller => "directors", :action => "create"})
  get("delete_actor/:an_id", { :controller => "directors", :action => "destroy"})
  post("modify_actor_record/:the_id", { :controller => "directors", :action => "update"})
end
